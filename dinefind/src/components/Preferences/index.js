    ...
    return(
        <div className="centered-container row">
            ...
            <FormGroup>
                ...
                <div className="row">
                <div className="col-6 preferences">
                    ...
                    <Switch className="switch" checked={state.visited} onChange={handleChange('visited')} value="visited" />
                         ...
                         />
                    <div className="indent"><p>(You will have the option to select and keep track of the restaurants you have been to on the search results page)</p></div>
                    <FormControlLabel control={
